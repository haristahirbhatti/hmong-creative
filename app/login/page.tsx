  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080808', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: "'DM Sans',sans-serif", padding: 20 }}>
      ...
      <div style={{ width: '100%', maxWidth: 400, background: '#0f0f0f', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 24, padding: '36px 32px' }}>
        ...
        <p style={{ color: '#444', fontSize: 14, margin: '0 0 24px' }}>Sign in to continue creating</p>
        ...
        <button onClick={handleLogin} disabled={loading || !!oauthLoading}
          style={{ width: '100%', padding: '14px', borderRadius: 12, border: 'none', background: loading ? '#1a1a1a' : '#FF5C2B', color: loading ? '#444' : 'white', fontSize: 15, fontWeight: 700, cursor: loading || oauthLoading ? 'not-allowed' : 'pointer', fontFamily: 'inherit' }}>
